...
export async function loanProcessingWorkflow(input: CustomerInfo): Promise<string> {
  ...
  // TODO Part B: Comment this out and uncomment the identical call below the loop
  ...
  // TODO Part B: Uncomment this and comment out the identical call above the loop
  // await sendThankYouToCustomer(input);
